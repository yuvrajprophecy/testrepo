...
def main():
    ...
    try:
        ...
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/farmers-markets-irs", config = Config)
    except :
        
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/farmers-markets-irs")
